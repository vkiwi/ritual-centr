...
<body>
  ...
  <main>
    ...
    <div class="general generalBenchesTables">
      <div class="general-background">
        <div class="container">
          <h1>~ Лавки и столы ~</h1>
          <p>Благоустройство могилы на кладбище – это процесс, позволяющий украсить место захоронение, сделать его
            аккуратным и достойным. Мы предлагаем лавочки и столы для облагораживания участка на кладбище. Лавочка или
            скамейка - это один из необходимых элементов при благоустройстве могилы. Они имеют хороший внешний вид и
            длительный срок эксплуатации. </p>
            <p>У нас представлен широкий
            выбор лавок и столов, которые вы можете посмотреть ниже, также некоторые экземпляры представлены в нашем салоне по адресу: <b
              class="about-p-b">г. Владимир, ул. Большая Нижегородская, д. 34</b> Вы можете заказать лавочку и стол по
            телефону: <b class="about-p-b"><a href="tel:+79209260957">8-920-926-09-57</a> (Viber, WhatsApp)</b></p>
            <br>

          <div id="gallery" style="display:none;">

            <img alt="Preview Image 1" src="../images/benchesTables/1.jpg" data-image="../images/benchesTables/1.jpg"
              data-description="Лавка кованая большая">

            <img alt="Preview Image 1" src="../images/benchesTables/2.jpg" data-image="../images/benchesTables/2.jpg"
              data-description="Лавка кованая ЛК1">

            <img alt="Preview Image 1" src="../images/benchesTables/3.jpg" data-image="../images/benchesTables/3.jpg"
              data-description="Лавка кованая ЛК2">

            <img alt="Preview Image 1" src="../images/benchesTables/4.jpg" data-image="../images/benchesTables/4.jpg"
              data-description="Лавка кованая ЛК3">

            <img alt="Preview Image 1" src="../images/benchesTables/5.jpg" data-image="../images/benchesTables/5.jpg"
              data-description="Лавка сварная ЛС1">

            <img alt="Preview Image 1" src="../images/benchesTables/6.jpg" data-image="../images/benchesTables/6.jpg"
              data-description="Стол квадратный">

            <img alt="Preview Image 1" src="../images/benchesTables/7.jpg" data-image="../images/benchesTables/7.jpg"
              data-description="Стол овальный">
